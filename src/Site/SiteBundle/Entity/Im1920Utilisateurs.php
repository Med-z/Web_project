 ...
 * Im1920Utilisateurs
 *
 * @ORM\Table(name="im1920_utilisateurs", uniqueConstraints={@ORM\UniqueConstraint(name="nom", columns={"identifiant"})})
 * @ORM\Entity
 */
class Im1920Utilisateurs
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="identifiant", type="string", length=30, nullable=false)
     */
    private $identifiant;
